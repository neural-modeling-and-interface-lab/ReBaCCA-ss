...
for alpha = alphaPool
    ...
    parfor iRepeat = 1:totalRepeat
        ...
        data = load(['Data/Simulated data_scenario2_' num2str(iRepeat)]);
    ...
    display(elapsedTime);
    % Save the data
    save(['Results\Loop for alpha at kernel_' num2str(kernel_width_pool) '_alpha_' num2str(alpha, '%.2f') '_scenario 2.mat'])
end