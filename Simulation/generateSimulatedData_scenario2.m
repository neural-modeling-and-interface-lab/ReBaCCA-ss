...
for iRepeat=1:totalRepeatTime
    ...
    mu1_1 = [1900 1900]; % Mean for the first group of neurons
    sigma1_1 = 75; % Standard deviation for the first group of neurons
    mu2_1 = [2500, 2500]; % Mean for the second group of neurons
    sigma2_1 = 50; % Standard deviation for the second group of neurons 150
    split_index1 = 18;
    basicFiring1 = [10 10];
    backgroundFiring1 = [0.002 0.002];
    
    % Gaussian parameters for second dataset
    mu1_2 = [3100, 3100]; % Mean for the first group of neurons
    sigma1_2 = 75; % Standard deviation for the first group of neurons
    mu2_2 = [2500, 2500]; % Mean for the second group of neurons
    sigma2_2 = 50; % Standard deviation for the second group of neurons 150
    split_index2 = 18;
    basicFiring2 = [10 10];
    ...
    save(['Data/Simulated data_scenario2_' num2str(iRepeat)]);
end
