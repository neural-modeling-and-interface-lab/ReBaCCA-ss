...
totalRepeat = 8;  % 2025-03-16 Original 8
type = 'multiply';
...
for alpha = alphaPool
    for iRepeat = 1:totalRepeat
        ...
        load(['Data/Simulated data_scenario2_' num2str(iRepeat)])
        ...
        parfor idx = 1:length(kernel_width_pool)
            ...
            % 2025-04-01 Add cut off threshold for fair comparison
    ...
    elapsedTime = toc;
    display(elapsedTime);
    save(['Results\Loop_for_kernel_at_alpha_' num2str(alpha,'%.2f') '_scenario 2.mat']);
end