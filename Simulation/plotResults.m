...
load('Results/Loop_for_kernel_at_alpha_0.50.mat')
...
%% Output the figure
export_pdf_figure(2,'Fig/Firing and raster only content',0)
export_pdf_figure(3,'Fig/Firing and raster only axis',0)
export_pdf_figure(4,'Fig/PCA and CCA',0)
export_pdf_figure(5,'Fig/ReBaCCA',0)
export_pdf_figure(6,'Fig/ReBaCCA-ss',0)
export_pdf_figure(8,'Fig/Correlation',0)
export_pdf_figure(10,'Fig/RMSE',0)
