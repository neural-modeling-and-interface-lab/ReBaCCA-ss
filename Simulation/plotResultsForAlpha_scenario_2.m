...
load('Results\Loop for alpha at kernel_45_alpha_0.00_scenario 2.mat')
...
for iAlpha = 1:length(alphaPoolName)
    load(['Results\Loop for alpha at kernel_45_alpha_' num2str(alphaPoolName{iAlpha}, '%.2f') '_scenario 2.mat'])
...
export_pdf_figure(gcf, 'Fig/Projection vector vs alpha scenario 2', 0);
...
export_pdf_figure(gcf, 'Fig/ReBaCCA vs alpha curve scenario 2', 0);
